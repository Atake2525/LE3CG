...
WireFrameObjectBase* WireFrameObjectBase::instance = nullptr;

WireFrameObjectBase* WireFrameObjectBase::GetInstance() {
	if (instance == nullptr) {
		instance = new WireFrameObjectBase;
	}
	return instance;
}

void WireFrameObjectBase::Finalize() {
	delete instance;
	instance = nullptr;
}

void WireFrameObjectBase::Initialize(DirectXBase* directxBase) {
	directxBase_ = directxBase;
	CreateGraphicsPipeLineState();
}

void WireFrameObjectBase::CreateRootSignature() {
...
void WireFrameObjectBase::CreateGraphicsPipeLineState() {
	CreateRootSignature();
	// PSOを作成する
...
void WireFrameObjectBase::ShaderDraw() {
